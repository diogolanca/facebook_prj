    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('views', models.PositiveIntegerField(default=0)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group_user', to='core.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('views', models.PositiveIntegerField(default=0)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('follower', models.ManyToManyField(related_name='page_members', to=settings.AUTH_USER_MODEL)),
